...
helptext<-"<p><b>Description:</b></p><p align='justify'>A calculator that tries to predict the optimal advertising value of Your flat in Budapest based on 45000 prior samples of flat advertisements, and a Random Forest model trained with <b>'CARET'</b> package in <b>R</b> language.</p><p><b>Usage:</b></p><ul><li>Choose a region of Budapest</li><li>Adjust size of Your flat</li><li>Give the number of rooms and half rooms</li><li>Push 'Calculate'</li></ul><p><b>Results:</b></p><p align='justify'>The histogram represents the distribution of prices in the area based on the test dataset, the <font color='red'>red vertical</font> represents the predictions's position in the price range.</p><p align='justify'>Since advertising prices are notoriously skwed by opportunism and misinformation, model fit is NOT perfect (Rsquared of 0.80). A very rough estimation of possible noise in the target area has been added as a warning. <b>USE AT YOUR OWN RISK!</b></p>"
